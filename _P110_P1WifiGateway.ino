...
//         str += F("<BR>");
  str += "<TR><TD>Teruggeleverd tarief 1: </TD><TD>";
    str += T281;
 //        str += F("<BR>");
   str += "</TD></TR> </TD></TR> <TR><TD>Teruggeleverd tarief 2: </TD><TD>";
    str += T282;
//         str += F("<BR>");
  str += "</TD></TR> <TR><TD>Actueel verbruik         : </TD><TD>";
    str += T170;
  //       str += F("<BR>");
   str += "</TD></TR> <TR><TD>Huidige teruglevering   : </TD><TD>";
    str += T270;
    str += "</TD></TR> <TR><TD>Totaal gasverbuik   : </TD><TD>";
   str += G2421;
 //        str += F("<BR><BR>");
   //  str += "Input   : ";
   //       str += inputString;
